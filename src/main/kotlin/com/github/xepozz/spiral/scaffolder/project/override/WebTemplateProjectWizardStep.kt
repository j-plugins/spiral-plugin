package com.github.xepozz.spiral.scaffolder.project.override

import com.github.xepozz.spiral.scaffolder.project.SpiralProjectGenerator
import com.github.xepozz.spiral.scaffolder.project.SpiralProjectGeneratorSettings
...
class WebTemplateProjectWizardStep(
    ...
    private fun webModuleBuilder(): WebModuleBuilder<SpiralProjectGeneratorSettings> {
