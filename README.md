...
![Build](https://github.com/j-plugins/spiral-plugin/workflows/Build/badge.svg)
...
[Github](https://github.com/j-plugins/spiral-plugin) | [Telegram](https://t.me/jb_plugins/684) | [Official Website](https://spiral.dev) | [Donation](https://github.com/xepozz/xepozz?tab=readme-ov-file#become-a-sponsor)
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "spiral-plugin"</kbd> >
  <kbd>Install</kbd>
...
- Manually:
  ...
  Download the [latest release](https://github.com/j-plugins/spiral-plugin/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
